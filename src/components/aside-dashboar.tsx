...
export default function Aside() {
  ...
  return (
    <aside
      ...
      aria-label="Sidebar"
    >
      <div className="borderR relative flex min-h-0 min-w-44 flex-1 flex-col border-background bg-secondary pt-0">
        <div className="flex flex-col overflow-y-auto pb-4 pt-5">
          <div className="flex-1 space-y-1 divide-y bg-secondary px-3">
